    ...
    <div className="w-full px-5 py-[100px]">
      <div className="w-full text-center">
        <p className="text-2xl md:text-5xl font-bold">
          ...
          <span className="text-2xl md:text-5xl font-bold bg-white bg-gradient-to-r from-[#9D0208] via-[#9D0208] to-[#550204] inline-block text-transparent bg-clip-text">
            and Enjoy
          </span>
        </p>
      ...
      <div className="max-w-screen-xl mx-auto mt-10">
        <div className="w-full mt-10 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5">
          <div className="works-card h-[400px] p-5 bg-gradient-to-l from-[#D00000] to-[#9D0208] text-white shadow-lg">
